...
class ModelService:
    """Holds the loaded model + allowed locations in memory. Load once at
    startup (see main.py lifespan) instead of on every request."""
    ...
    def load(self) -> None:
        ...
        if not model_path.exists():
            raise FileNotFoundError(
                ...
                "Run the notebook to train and export house_price.pkl first."
            )
